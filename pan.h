...
#define PanSource	"dsr_protocol.pml"
...
#define _nstates4	11	/* message_delivery */
#define minseq4	204
#define maxseq4	213
#define _endstate4	10

#define _nstates3	11	/* deadlock_free */
#define minseq3	194
#define maxseq3	203
#define _endstate3	10

#define _nstates2	11	/* message_delivery */
#define minseq2	184
#define maxseq2	193
...
#define _nstates0	174	/* Node */
#define minseq0	0
#define maxseq0	172
#define _endstate0	173
...
struct route_t { /* user defined type */
	int path[10];
	int length;
};
typedef struct P4 { /* message_delivery */
...
typedef struct P3 { /* deadlock_free */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
typedef struct P2 { /* message_delivery */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, _5_4_i) - 1*sizeof(int))

#define PNode	((P0 *)_this)
typedef struct P0 { /* Node */
...
#endif
	unsigned isSource : 1;
	unsigned isReceiver : 1;
	uchar receivedRREQs[10];
	int id;
	int messageCounter;
	int sender;
	int receiver;
	...
	int i;
	int _4_1_count;
	int _4_1_neighborIndex;
	int _4_1_neighbor;
	int _4_2_1_nextNode;
	int _4_2_2_count;
	int _4_2_2_neighborIndex;
	int _4_2_2_neighbor;
	int _4_3_routeIndex;
	int _4_3_3_nextNode;
	int _4_1_neighbors[4];
	int _4_2_2_neighbors[4];
	struct route_t route;
	struct route_t newRoute;
	struct route_t _4_2_routeCopy;
} P0;
#define Air0	0
